...
export const getModelsForSelectFailure = createAction('[Model] Get Models For Select Failure', props<{ error: HttError }>());
...
export const getModelsFailure = createAction('[Model] Get Models Failure', props<{ error: HttError }>());
...
export const getModelFailure = createAction('[Model] Get Model Failure', props<{ error: HttError }>());
...
export const createModelFailure = createAction('[Model] Create Model Failure', props<{ error: HttError }>());
...
export const updateModelFailure = createAction('[Model] Update Model Failure', props<{ error: HttError }>());
...
export const deleteModelFailure = createAction('[Model] Delete Model Failure', props<{ error: HttError }>());