...
export const carReducer = createReducer(initialState, on(CarAction.resetCarFilter, (state) => ({ ...state, carFiltering: resetCarFilter() })), on(CarAction.setCurrentCarDTO, (state, action) => ({ ...state, currentCar: action.carDTO })), on(CarAction.setCarFilteringModel, (state, action) => ({ ...state, carFiltering: { ...state.carFiltering, ...action.carFiltering, } })), on(CarAction.setGridColomnCount, (state, action) => ({ ...state, colomnCount: action.colomnCount })), on(CarAction.getCars, state => ({ ...state, currentViewCarLoading: true, error: null })), on(CarAction.getCarsSuccess, (state, action) => ({ ...state, currentViewCarLoading: false, cars: action.dtoWithTotal.dtoObjects, totalCars: action.dtoWithTotal.total })), on(CarAction.getCarsFailure, (state, action) => ({ ...state, currentViewCarLoading: false, error: action.error })), on(CarAction.getMaxPrice, state => ({ ...state, error: null })), on(CarAction.getMaxPriceSuccess, (state, action) => ({ ...state, maxPrice: action.maxPrice })), on(CarAction.getCarColors, state => ({ ...state, error: null })), on(CarAction.getCarColorsSuccess, (state, action) => ({ ...state, colors: action.colors })), on(CarAction.getCarEngine, state => ({ ...state, error: null })), on(CarAction.getCarEngineSuccess, (state, action) => ({ ...state, engine: action.engineCapacities })), on(CarAction.getCar, state => ({ ...state, error: null })), on(CarAction.getCarSuccess, (state, action) => ({ ...state, currentViewCar: action.car })), on(CarAction.getCarFailure, (state, action) => ({ ...state, error: action.error })), on(CarAction.createCar, state => ({ ...state, error: null })), on(CarAction.createCarSuccess, state => ({ ...state, error: null, currentCar: null })), on(CarAction.updateCar, state => ({ ...state, error: null })), on(CarAction.updateCarSuccess, state => ({ ...state, error: null, currentCar: null })), on(CarAction.deleteCar, state => ({ ...state, error: null })));
